...
#define CPP_COMPILER_VERSION \
    CPP_COMPILER_VERSION_CREATE(CPP_COMPILER_MAJOR, CPP_COMPILER_MINOR, CPP_COMPILER_PATCH)

#define CPP_COMPILER_IS(compiler) (CPP_COMPILER == (compiler))

#define CPP_COMPILER_IS_NOT(compiler) (CPP_COMPILER != (compiler))

#define CPP_COMPILER_VERSION_IS_ATLEAST(major, minor, patch) (CPP_COMPILER_VERSION_CREATE(major, minor, patch) <= CPP_COMPILER_VERSION)

#define CPP_COMPILER_VERSION_IS_BELOW(major, minor, patch) (CPP_COMPILER_VERSION_CREATE(major, minor, patch) > CPP_COMPILER_VERSION)
