...
#   define CPP_MSVC_SUPPRESS_WARNING_WITH_PUSH(warning_number) CPP_MSVC_SUPPRESS_WARNING_PUSH CPP_MSVC_SUPPRESS_WARNING(warning_number)
...
#   define CPP_CLANG_SUPPRESS_WARNING_WITH_PUSH(warning) CPP_CLANG_SUPPRESS_WARNING_PUSH CPP_CLANG_SUPPRESS_WARNING(warning)
#   define CPP_CLANG_SUPPRESS_WARNING_POP                _Pragma("clang diagnostic push")
#   define CPP_COMPILER_WARNING(msg)                     _Pragma(CPP_STRINGIFY(GCC warning(__FILE__ "(" CPP_STRINGIFY(__LINE__) ") : warning: " msg)))
#else
...
#define CPP_UNUSED_PARAMETER(parameter) \
    ((void) (parameter))
